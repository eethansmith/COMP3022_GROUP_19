...
/**
 * Creates a line chart displaying the provided field, highlighting the selected region.
 ...
 */
const RadarGraph = ({ field, selectedRegion, setSelectedRegion, ...props }) => {
    ...
    return (
        <div {...props} style={{display: "grid"}}>
            <h3>Displaying RadarGraph for: {selectedRegion}</h3>
